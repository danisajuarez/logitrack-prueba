          ...
          <div className="md:col-span-2 sticky bottom-0 bg-neutral-900 border-t border-neutral-700 -mx-4 md:mx-0 px-4 md:px-0 py-4 md:py-0 md:border-0 md:static flex justify-between items-center gap-3 mt-4">
            {viaje && (
              <button
                ...
                disabled={deleting}
                className="px-4 py-2.5 rounded-lg bg-red-600 hover:bg-red-700 disabled:bg-red-800 disabled:cursor-not-allowed text-white font-medium flex items-center gap-2 transition-colors"
              >
                {deleting ? (
                  <svg
