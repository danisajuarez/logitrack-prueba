      ...
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-12">
          ...
          <div className="flex items-start justify-between flex-wrap gap-4 mb-6">
            <div>
              ...
              <p className="text-neutral-400 text-sm md:text-base">
                Resumen general del sistema de gestiÃ³n de viajes
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 md:mb-12">
          ...
          <div className="bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700 rounded-lg p-4 md:p-6">
            ...
            <p className="text-xs text-neutral-500 mt-1">Viajes prÃ³ximos</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-neutral-800 to-neutral-900 border border-neutral-700 rounded-lg p-4 md:p-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-2xl">ðŸ‘¨â€âœˆï¸</span>
            </div>
        ...
        <div className="bg-neutral-800/50 border border-neutral-700 rounded-lg p-4 md:p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl md:text-2xl font-bold">PrÃ³ximos Viajes</h2>
            <Link
              href="/viajes"
          ...
          {loading ? (
            ...
            <div className="text-center py-12 text-neutral-400">
              <p className="text-lg mb-2">No hay viajes prÃ³ximos</p>
              <p className="text-sm">Los viajes programados aparecerÃ¡n aquÃ­</p>
            </div>
          ) : (
